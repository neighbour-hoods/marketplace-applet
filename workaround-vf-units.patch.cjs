...
const REPLACEMENT_FILE_PATH = path.resolve(__dirname, './node_modules/.pnpm/@valueflows+vf-graphql-holochain@0.0.1-alpha.21_graphql@15.8.0_ws@8.13.0/node_modules/@valueflows/vf-graphql-holochain/queries/unit.js')
